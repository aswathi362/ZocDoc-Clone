...
function ZocdocApp() {
  return (
    <div className='bg-bright-orangle grid grid-cols-1 md:grid-cols-2 px-20 pt-20 z-0'>
        <div className=''>
        ...
        <div className='relative'>
            <img src={zocdocAppArrow} className='absolute hidden lg:block -left-24 -top-10 w-64'/>
            <svg className='absolute bottom-0 lg:-right-48 w-fit z-10 overflow-hidden' width="1054" height="409" viewBox="0 0 1054 409" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <img src={zocdocApp} className='relative z-20'/>
        </div>
    </div>
  )
}
