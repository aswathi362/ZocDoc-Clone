...
function Hero() {
  ...
  return (
    <div className='container py-16 px-12 mx-auto relative'>
        <p className='text-xl mb-3 lg:text-5xl lg:mb-6 font-light leading-tight'>Book local <span className='swipe-text'>{words[currentWordIndex]}</span><br/>who take you insurance</p>
